<?php
// Register Custom cargos_especiales
require PLUGIN_DIR . 'cpt/metabox_cargos_especiales.php';
function custom_post_type_cargos_especiales() {

	$labels = [
		'name'                  => _x( 'cargos_especiales', 'cargos_especiale General Name', 'wp-reserves-system' ),
		'singular_name'         => _x( 'cargos_especiale', 'cargos_especiale Singular Name', 'wp-reserves-system' ),
		'menu_name'             => __( 'cargos_especiales', 'wp-reserves-system' ),
		'name_admin_bar'        => __( 'cargos_especiale', 'wp-reserves-system' ),
	...
	$args = [
		'label'                 => __( 'cargos_especiale', 'wp-reserves-system' ),
	...
	register_post_type( 'cargos_especiales', $args );

}

add_action( 'init', 'custom_post_type_cargos_especiales');