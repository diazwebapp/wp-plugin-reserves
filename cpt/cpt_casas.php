<?php
// Register Custom casas

function custom_post_type_casas() {

	$labels = [
		'name'                  => _x( 'casas', 'cargos_especiale General Name', 'wp-reserves-system' ),
		'singular_name'         => _x( 'cargos_especiale', 'cargos_especiale Singular Name', 'wp-reserves-system' ),
		'menu_name'             => __( 'casas', 'wp-reserves-system' ),
...
add_action( 'init', 'custom_post_type_casas');